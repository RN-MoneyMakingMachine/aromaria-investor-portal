...
export const ADOPTION_STEPS = {
  ...
  "CM-07": [
    "IT Policy communicated to the Board and Omoy Designated Representative with formal acknowledgment — Jorge Nikaido (CEO) + Rodrigo Nikaido (CGO) — Month 1",
    "IT Manager job description, scope, and reporting line documented (reports to CGO, manages day-to-day IT operations during implementation and ongoing) — Rodrigo Nikaido (CGO) — Month 1",
    "IT Manager recruitment launched — Rodrigo Nikaido (CGO) + HR Lead — Month 1",
    "Aromaria Technology Stack inventory completed and documented (Google Workspace, Monday.com, HubSpot, ZoomInfo, Zoom, Claude, GitHub, Railway, Docker, n8n, plus all other active tools) — Rodrigo Nikaido (CGO) — Month 2",
    "Technology Vendor Approval Log established with all existing tech vendors retroactively documented — Rodrigo Nikaido (CGO) — Month 2",
    "Joint CEO + CGO approval mechanism operational for tech vendor contracts at or above $10K annual value — Jorge Nikaido (CEO) + Rodrigo Nikaido (CGO) — Month 2",
    "IT Manager hired and onboarded — Rodrigo Nikaido (CGO) — Month 3 (no later)",
    "IT Manager assumes operating responsibility for the Technology Division under CGO leadership — Rodrigo Nikaido (CGO) — Month 3",
    "Monthly IT monitoring cadence designed and operational — covers access permissions review, software inventory, MFA compliance, vendor list updates, AI tool inventory, incident log — IT Manager — Month 3",
    "Quarterly IT monitoring cadence designed and operational — covers vendor security review, data privacy compliance check, Technology Vendor Approval Log audit, AI governance review — IT Manager + Rodrigo Nikaido (CGO) — Month 4",
    "Annual IT monitoring cadence designed and operational — covers full annual security review, trademark portfolio review, data privacy framework refresh, IT Policy review — IT Manager + Rodrigo Nikaido (CGO) — Month 4",
    "MFA deployment completed across all Aromaria Technology Stack platforms — IT Manager — Month 4",
    "Personnel IT training (initial round) including AI governance training delivered company-wide — IT Manager + HR Lead — Month 5",
    "Departing personnel offboarding procedure operational with Stack-specific checklists — IT Manager + HR Lead — Month 5",
    "Live monitoring system operational for critical IT items (real-time visibility for: MFA compliance, anomalous access, incident detection, Technology Vendor Approval Log compliance) — IT Manager + Rodrigo Nikaido (CGO) — Month 6",
    "IT Policy communicated company-wide as part of the Single Governance Suite Acknowledgment — HR Lead — Month 5",
    "First annual IT security review completed and results included in Board Annual Report — IT Manager + Rodrigo Nikaido (CGO) — Month 7",
    "Board approval obtained for Aromaria Enterprise Claude Deployment as material strategic IT initiative — Jorge Nikaido (CEO) + Rodrigo Nikaido (CGO) — Month 7",
    "Enterprise Claude Deployment executed across personnel from junior executive through C-Suite level (Q3 2026 target) — Rodrigo Nikaido (CGO) + IT Manager — Month 8",
    "Monthly IT monitoring report reviewed at Board meeting — IT Manager / CGO — Monthly",
    "Quarterly IT section in Quarterly Board Pack including Technology Vendor Approval Log audit results — IT Manager / CGO — Quarterly",
    "Annual full IT Policy review at Board with results in Board Annual Report — Office of the CEO — Annual",
  ],
